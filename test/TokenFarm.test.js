...
contract('TokenFarm', ([owner, invester]) => {
  ...
  before(async () => {
    ...
    // await daiToken.transfer(accounts[1], tokens('100'), {from: accounts[0]})    // why we used 'from' parameter - because we have to tell from who an invester receive the mDai
